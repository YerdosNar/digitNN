// nn_lib.c - Neural Network Library Implementation
// Contains all the common functions used by the neural network programs
// Compile to object file: gcc -c nn_lib.c -o nn_lib.o -O3 -march=native -ffast-math
